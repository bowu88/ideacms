...
class AdsenseController extends Admin {
    ...
    public function indexAction() {
	    ...
	    $pagesize = 8;
	    $url      = url('admin/adsense/index', array('page'=>'{page}'));
	    ...
	    $this->view->display('admin/adsense_list');
    }
    ...
    public function addAction() {
        if ($this->isPostForm()) {
            ...
            $this->adminMsg('操作成功', url('admin/adsense'), 3, 1, 1);
        }
        $this->view->display('admin/adsense_add');
    }
	...
	public function alistAction() {
	    ...
	    $pagesize = 8;
	    $url      = url('admin/adsense/alist', array('page'=>'{page}'));
	    ...
	    $this->view->display('admin/adsense_alist');
    }
	...
	public function addaAction() {
        ...
        $this->view->display('admin/adsense_adda');
    }
    ...
    public function editaAction() {
        ...
        if ($this->post('submit')) {
            ...
            $this->adminMsg('操作成功', url('admin/adsense/alist', array('aid'=>$aid)), 3, 1, 1);
        }
        $list    = $this->getType();
    ...
    public function disabledAction() {
        ...
        $this->adminMsg('操作成功', url('admin/adsense/alist', array('aid'=>$data['aid'])), 3, 1, 1);
    }
